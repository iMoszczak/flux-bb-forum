...
<script src="/static/js/notifications.js" type="text/javascript" charset="UTF-8"></script>
<script src="/static/js/chat.js?v=7rr364g200d3asdl6" type="text/javascript" charset="UTF-8"></script>
<?php
...
$tpl_main = str_replace('<pun_title>', '<h1><a href="index.php">game<span>sense</span></a></h1>', $tpl_main);
// END SUBST - <pun_title>
...
if ($pun_user['group_id'] == 1 || $pun_user['group_id'] == 2)//($pun_user['g_read_board'] == '1' && $pun_user['g_view_users'] == '1')
...
else
{
	...
	$premium_date = new DateTime($pun_user['premium_date']);
	$userdate = $premium_date->format('Y-m-d H:i:s');
	if ($pun_user['group_id'] != 4) {	
        if ($pun_user['premium_date'] != null ){ 						
            $page_statusinfo[] = '<li><span><strong>Premium (Counter-Strike: Global Offensive)</strong> until '.$userdate.' [<a href="payment.php?game=csgo">extend subscription</a>]</span></li>';
            $page_statusinfo[] = '<li><span><a href="viewtopic.php?id=2">Frequently asked questions</a> • <a href="viewtopic.php?id=4">Common issues</a></span></li>';
        } else {
